...
ifeq ($(filter S805X2 S905C2 S905C3ENG S905X4 S905Y4, $(BOARD_AML_SOC_TYPE)),)
    LOCAL_SRC_FILES_32 := ta/v3/dev/common/$(LOCAL_MODULE)$(LOCAL_MODULE_SUFFIX)
else
    LOCAL_SRC_FILES_32 := ta/v3/dev/$(BOARD_AML_SOC_TYPE)/$(LOCAL_MODULE)$(LOCAL_MODULE_SUFFIX)
endif
include $(BUILD_PREBUILT)
endif
